...
const WhoWeAreSection = () => {
    return (
        <section className="flex flex-col md:flex-row items-center justify-between px-6 py-12 md:px-20 bg-white">
            {/* Left Content */}
            <div className="md:w-1/2 mb-10 md:mb-0 lg:px-0 px-8">
            ...
            {/* Right Content */}
            <div className="relative md:w-1/2 px-4 sm:px-6 md:px-10">
                {/* Floating Image */}
                <motion.img
                    src={kidsImage}
                    alt="Kids with Robot"
        ...
        `                rounded-full 
                ...
                <motion.div
                    className="
      absolute 
      top-4 right-4       /* mobile */
      sm:top-6 sm:right-10
      md:top-8 md:right-12
      lg:top-10 lg:right-20
      bg-orange-500 
      text-white 
      rounded-full 
      px-4 py-2          /* smaller padding for mobile */
      sm:px-5 sm:py-3
      md:px-6 md:py-4 
      text-center 
      transform translate-x-1/3 -translate-y-1/3 
      shadow-md
      border-2 sm:border-3 md:border-4 border-b-white
    "
                ...
                >
                    ...
                    <p className="text-xs sm:text-sm md:text-base uppercase font-semibold tracking-wide">
                        Member Active
                    </p>
                </motion.div>
            </div>
